...
import 'package:ship_link/cubits/orderHistory/order_history_state.dart';
import 'package:ship_link/data/services/cartServeices/cart_serveices.dart';

export 'package:ship_link/cubits/orderHistory/order_history_state.dart';

class OrderHistoryCubit extends Cubit<OrderHistoryState> {
  final CartServeices _service;
