...
import 'package:ship_link/user/presentation/screens/signup/register/User/components/space.dart';
import 'package:ship_link/user/presentation/screens/signup/register/User/components/title_text_field.dart';
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const Space(),
                          TitleTextField(
                            text: context.t.tr('phone_number'),
                          ),
                          const SizedBox(
                            height: 5,
                          ),
                          BuildTextField(
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                                return context.t.tr('phone_required');
                              }
                              if (value.length < 10) {
                                return context.t.tr('phone_invalid');
                              }
                              return null;
                            },
                            inputFormatters: [
                          ...
                          ValueListenableBuilder<bool>(
                            ...
                            builder: (context, vis, _) => BuildTextField(
