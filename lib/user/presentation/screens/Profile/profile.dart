...
import 'package:ship_link/user/presentation/screens/orders/order_history.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _StatsCard(key: ValueKey('stats_${_refreshNotifier.value}')),
              SizedBox(height: 16.h),
              _ReferralCard(key: ValueKey('referral_${_refreshNotifier.value}')),
              SizedBox(height: 20.h),
              _MyOrders(key: ValueKey('orders_${_refreshNotifier.value}')),
              SizedBox(height: 20.h),
              _AccountSettings(),
              SizedBox(height: 20.h),
              _SupportSection(),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (loading)
                SizedBox(height: 20.h, child: Center(child: CircularProgressIndicator(strokeWidth: 2)))
              else ...[
                Row(
                  children: [
                    Expanded(
                    ...
                    GestureDetector(
                      onTap: () {
                        if (code != null) {
                          SharePlus.instance.share(ShareParams(text: ReferralService().shareText(code!)));
                        }
                      },
                      child: Container(
...
class _ProfileAvatarState extends State<_ProfileAvatar> {
  ...
  Future<void> _loadAvatar() async {
    ...
    final data = await Supabase.instance.client
        ...
        .maybeSingle();
    if (data != null) {
      _avatarNotifier.value = data['avatar_url'] as String?;
    }
  }
