...
import 'package:ship_link/user/presentation/cubits/orderHistory/order_history_cubit.dart';
...
class _OrderHistoryBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: BlocBuilder<OrderHistoryCubit, OrderHistoryState>(
