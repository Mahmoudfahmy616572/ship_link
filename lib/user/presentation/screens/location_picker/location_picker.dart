...
import 'package:ship_link/core/services/geocoding_service.dart';
...
class _LocationPickerState extends State<LocationPicker> {
  final _selectedLocation = ValueNotifier<MapLatLng?>(null);
  final _mapController = Completer<AdaptiveMapController>();
  final _markers = ValueNotifier<List<MapMarker>>([]);
  final _locationGranted = ValueNotifier<bool>(false);
  ...
  Future<void> _initLocation() async {
    ...
    if (granted) {
      try {
        ...
        _selectedLocation.value = MapLatLng(lat, lng);
        _markers.value = [
          MapMarker(
            id: 'selected',
            latitude: lat,
  ...
  void _save() async {
    ...
    final lng = _selectedLocation.value!.longitude;
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      listenable: Listenable.merge([_locationGranted, _selectedLocation, _markers]),
      builder: (context, _) {
        final locGranted = _locationGranted.value;
        final selLoc = _selectedLocation.value;
              ...
              children: [
                ...
                Expanded(
                  child: AdaptiveMap(
                    ...
                    onTap: _onMapTap,
                    markers: markers,
                    showMyLocation: locGranted,
                    showMyLocationButton: locGranted,
                    onMapCreated: (ctrl) {
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: selLoc != null ? _save : null,
